package thepurplepoe.mythometallurgy.common.entity;
...
public class EntityDivineArrow extends Entity implements IProjectile
{
    ...
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(EntityDivineArrow.class, DataSerializers.BYTE);
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public EntityDivineArrow.PickupStatus pickupStatus;
    ...
    public EntityDivineArrow(World worldIn)
    {
        ...
        this.yTile = -1;
        this.zTile = -1;
        this.pickupStatus = EntityDivineArrow.PickupStatus.DISALLOWED;
        this.damage = 2.0D;
    ...
    public EntityDivineArrow(World worldIn, EntityLivingBase shooter)
    {
        ...
        {
            this.pickupStatus = EntityDivineArrow.PickupStatus.ALLOWED;
        }
    }
    ...
    protected void onHit(RayTraceResult raytraceResultIn)
    {
        ...
        if (entity != null)
        {
            ...
            else
            {
                ...
                {
                    if (this.pickupStatus == EntityDivineArrow.PickupStatus.ALLOWED)
                    {
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        {
            this.pickupStatus = EntityDivineArrow.PickupStatus.getByOrdinal(compound.getByte("pickup"));
        }
        else if (compound.hasKey("player", 99))
        {
            this.pickupStatus = compound.getBoolean("player") ? EntityDivineArrow.PickupStatus.ALLOWED : EntityDivineArrow.PickupStatus.DISALLOWED;
        }
    }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn)
    {
        ...
        {
            boolean flag = this.pickupStatus == EntityDivineArrow.PickupStatus.ALLOWED || this.pickupStatus == EntityDivineArrow.PickupStatus.CREATIVE_ONLY && entityIn.capabilities.isCreativeMode;

           // if (this.pickupStatus == EntityDivineArrow.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.getArrowStack()))
            //{
            //    flag = false;
           // }
    ...
    public static enum PickupStatus
    {
        ...
        public static EntityDivineArrow.PickupStatus getByOrdinal(int ordinal)
        {
